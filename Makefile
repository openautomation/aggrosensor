...
COMPILE = avr-g++ -Wall -Os -DF_CPU=$(CLOCK) -mmcu=$(DEVICE) -I. -ffunction-sections
...
clean:
	rm -f aggro.hex main.elf $(OBJECTS) $(OBJECTS:.o=.d)
...
aggro.hex: main.elf
	rm -f aggro.hex
	avr-objcopy -j .text -j .data -O ihex main.elf aggro.hex
